          ...
          <table id="marksTable">
            ...
            <tbody id="marksTableBody">
              ...
              if (isset($_POST["fetchDetails"])) {
                ...
                echo "<div class='btn5'>";
                echo "<input type='submit' name='submitAttendance' id='submitAttendance' value='Submit Attendance'>";
                echo "<button class='submit-button'><a href='/Attendance Report/index.php'>See Report</a></button>";
                echo "</div>";
